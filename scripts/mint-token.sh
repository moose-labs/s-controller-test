...
spl-token create-account EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v --owner 54GvzEwe25N55wJ8zQZ4YTFjFAnDVP6fj4ZrvVhAyafq --fee-payer ./deps/configs/user2.json
spl-token create-account 3NZ9JMVBmGAqocybic2c7LQCJScmgsAZ6vQqTDzcqmJh --owner 54GvzEwe25N55wJ8zQZ4YTFjFAnDVP6fj4ZrvVhAyafq --fee-payer ./deps/configs/user2.json

...
pub struct SplCalculatorClient {
    rpc_client: RpcClient,
    pub payer: Keypair,
}

impl Client for SplCalculatorClient {
...
impl SplCalculatorClient {
    pub async fn get_calculator_state(&self) -> Result<CalculatorState> {
        let program_state = self
            .get_borsh_account_data(&self.get_spl_calculator_state_pubkey())
            .await?;
    ...
    pub fn get_spl_calculator_state_pubkey(&self) -> Pubkey {
